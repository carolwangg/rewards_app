...
export default function SignUp({phoneNumber, setPhoneNumber, onSignUp}: props) {
    ...
    const acceptTerms = () => {
        //toggle checkBox
        setChecked(!checked);
        const color = checked ? '#ededed' : 'rgba(255, 255, 255, 1)';
        setCheckFill(color);
    }
  ...
  return (
    <View testID={"139:1288"} style={styles.root}>
        ...
        <View testID="139:1197" style={styles.signUpBox}>
            ...
            {/* <View testID="139:1198" style={styles.countrySelector}>
                <View testID="139:1242" style={styles.countryFrame}>
                    <Text testID="139:1199" style={styles.countryText}>
                    {`Country`}
                    </Text>
                </View>
            </View> */}
            ...
            <View testID="7:120" style={styles.joinRow}>  
                <Pressable testID="139:1268" style={styles.joinNowButton} onPress={() => onSignUp()}>
...
const DropdownComponent = ({data, value, setValue, subFunction, placeholder}: dropdownProps) => {
    return <Dropdown
        style={[styles.countrySelector, { borderColor: 'blue' }]}
        containerStyle={styles.containerStyle}
        placeholderStyle={styles.countryText}
        selectedTextStyle={styles.countryText}
        inputSearchStyle={styles.countryText}
