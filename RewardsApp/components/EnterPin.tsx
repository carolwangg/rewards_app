...
import { Dimensions, StyleSheet, Text, TextInput, TouchableWithoutFeedback, View, Keyboard, Pressable } from 'react-native';
    ...
    <View testID={"53:187"} style={styles.root}>
      <View style={styles.phone}>
        ...
        <View style={styles.body}>
            ...
            <View testID="7:120" style={styles.frame23}>
              <Pressable testID="7:111" style={styles.frame14} onPress={() => {setVerifying(false)}}>
                <Text testID="7:112" style={styles.back}>
                  {`Back`}
                </Text>
              </Pressable>
              <Pressable testID="7:114" style={styles.frame21} onPress={() => { sendDigits() }}>
